function Plot_Budyko_CCVLUCCAADR
load BudykoResult
...
H_AADR(1, 1).FaceColor = [178,24,43]./255; H_AADR(1, 2).FaceColor = [33,102,172]./255;
...
%
text(-180,365,num2str(sum(AADR<0 & delta_obs<0)),'Color',[178,24,43]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(-150,365,['(',num2str(sum(AADR<0 & delta_obs<0 & pt_obs<0.1)),')'],'Color',[244,109,67]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(-180,325,num2str(sum(AADR<0 & delta_obs>0)),'Color',[33,102,172]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(-150,325,['(',num2str(sum(AADR<0 & delta_obs>0 & pt_obs<0.1)),')'],'Color',[116,173,209]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');

%
text(130,365,num2str(sum(AADR>=0 & delta_obs<0)),'Color',[178,24,43]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(160,365,['(',num2str(sum(AADR>=0 & delta_obs<0 & pt_obs<0.1)),')'],'Color',[244,109,67]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(130,325,num2str(sum(AADR>=0 & delta_obs>0)),'Color',[33,102,172]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(160,325,['(',num2str(sum(AADR>=0 & delta_obs>0 & pt_obs<0.1)),')'],'Color',[116,173,209]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
