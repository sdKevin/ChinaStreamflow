function Plot_CCVLUCCAADR_ColorPs(delta_obs,delta_nat,delta_ISIMIP_Close_obs,delta_ISIMIP_Close_nat1,pt_obs,CCV,LUCC,HHI)
% Start plotting
Edges = [-200:10:200];
...
H_HHI(1, 1).FaceColor = [244,109,67]./255; H_HHI(1, 2).FaceColor = [116,173,209]./255;
...
%
text(-180,365,num2str(sum(HHI<0 & delta_obs<0)),'Color',[244,109,67]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(-150,365,['(',num2str(sum(HHI<0 & delta_obs<0 & pt_obs<0.1)),')'],'Color',[178,24,43]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(-180,325,num2str(sum(HHI<0 & delta_obs>0)),'Color',[116,173,209]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(-150,325,['(',num2str(sum(HHI<0 & delta_obs>0 & pt_obs<0.1)),')'],'Color',[33,102,172]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');

%
text(130,365,num2str(sum(HHI>=0 & delta_obs<0)),'Color',[244,109,67]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(160,365,['(',num2str(sum(HHI>=0 & delta_obs<0 & pt_obs<0.1)),')'],'Color',[178,24,43]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(130,325,num2str(sum(HHI>=0 & delta_obs>0)),'Color',[116,173,209]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
text(160,325,['(',num2str(sum(HHI>=0 & delta_obs>0 & pt_obs<0.1)),')'],'Color',[33,102,172]./255,'FontSize',15,'FontName','Arial','FontWeight','Bold');
